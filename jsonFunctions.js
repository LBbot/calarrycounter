...
function editFood(arrayOf10Fields, oldJSON) {
    ...
    const couchPath = "foods/";
    const url = baseCouchURL + couchPath;
    // Actual add request + linter doesn't like Couch underscores so make exception)
...
function calcValidator(formFoodID, formType, formAmount) {
    ...
    return couch.get(baseCouchURL, "foods/_design/viewByName/_view/viewByNames").then(function (foodList) {
